...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train_loss, train_EPE = train(train_loader, model, optimizer, epoch, train_writer, val_loader, args.start_unsupervised)
...
def train(train_loader, model, optimizer, epoch, train_writer, val_loader, start_unsupervised):
    global n_iter, args
