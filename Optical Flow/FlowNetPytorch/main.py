...
# parser.add_argument('--start-unsupervised', default=10, type=int,
#                     help='manual epoch number for when to start unsupervised learning') 
...
def main():
    ...
    # tb.configure(argv=[None, '--logdir', save_path])
    # url = tb.launch()
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train_loss, train_EPE = train(train_loader, model, optimizer, epoch, train_writer, val_loader)
...
def train(train_loader, model, optimizer, epoch, train_writer, val_loader):
    global n_iter, args
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        # if epoch > start_unsupervised:
        #     if epoch == start_unsupervised+1:
        #         print("now starting unsupervised training")
